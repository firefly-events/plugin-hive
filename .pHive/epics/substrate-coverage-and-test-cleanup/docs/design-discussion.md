...
5. **Gate ownership invariant** — mode skills produce artifacts but never advance review/sign-off gates. *Source:* outline line 20, `plan-mode-cc-workflows/SKILL.md:26+80`. Single-citation pending smoke-audit recovery (see Risk #high #2).
