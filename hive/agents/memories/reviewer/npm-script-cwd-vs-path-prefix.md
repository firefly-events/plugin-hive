...
fails with "Could not find" because it resolves to `hive/lib/hive/lib/...`. When a
...
prove the npm wiring works. See `hive/lib/package.json:8` for the broken pattern.
