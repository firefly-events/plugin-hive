...
The wiki-compilation step in L1 implements `compile()`. With ChromaDB-backed L3, `read()` is the primary method that changes — the rest of the interface remains identical.
