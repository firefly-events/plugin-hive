...
| `mcp_config` | object | no | `{}` | Agent-specific MCP configuration. |
...
When omitted, optional fields default to `max_concurrent_tasks=1`, `custom_env={}`, `custom_args=[]`, `mcp_config={}`, `skills=[]`, and `visibility='workspace'`.
